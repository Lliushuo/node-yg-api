...
router.get("/classify", (req, res, next) => {
    ...
    classifyModel = Classify.classfl.find({CategoryName:name})
...
const usermodel=require("../model/insert/user.js")
const moment = require("moment") //处理时间模块
router.post('/register',(req,res,next)=>{
	 req.body.createTime = moment().format("YYYY-MM-DD HH:mm");
	 let stauts=usermodel.user.find({name})
})
